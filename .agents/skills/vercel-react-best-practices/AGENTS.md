...
Libraries commonly affected: `lucide-react`, `@mui/material`, `@mui/icons-material`, `@tabler/icons-react`, `react-icons`, `@headlessui/react`, `@base-ui/react/*`, `lodash`, `ramda`, `date-fns`, `rxjs`, `react-use`.

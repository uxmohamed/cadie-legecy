        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-10 pt-6 sm:pt-8 lg:pt-10 pb-12">
          ...
          <div className="prose prose-lg max-w-none text-[var(--fg)]">
            <p className="text-[var(--fg-muted)] mb-6">
              <strong>Cadie</strong> values your privacy. This Privacy Policy explains how we collect, use, and protect your information when you use <a href="http://cadie.app" className="text-[var(--fg)] underline hover:text-[var(--fg-muted)]"><strong>cadie.app</strong></a> ("Cadie", "we", "us", or "our").
            </p>
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Information We Collect</h2>
            <p className="text-[var(--fg-muted)] mb-4">
              Cadie only collects the information needed to provide, secure, and improve the service.
            </p>

            <h3 className="text-xl font-semibold text-[var(--fg)] mt-6 mb-3">Information you provide</h3>
            ...
            <h3 className="text-xl font-semibold text-[var(--fg)] mt-6 mb-3">Information collected automatically</h3>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">How We Use Your Information</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Data Storage and Security</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Third-Party Services</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Cookies and Similar Technologies</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Your Rights</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Data Retention</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Changes to This Policy</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">Contact</h2>
            <p className="text-[var(--fg-muted)] mb-4">

        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-10 pt-6 sm:pt-8 lg:pt-10 pb-12">
          ...
          <div className="prose prose-lg max-w-none text-[var(--fg)]">
            ...
            <p className="text-[var(--fg-muted)] mb-6">
              Welcome to <strong>Cadie</strong> ("Cadie", "we", "us", or "our"). These Terms of Service ("Terms") govern your access to and use of Cadie, including <a href="http://cadie.app" className="text-[var(--fg)] underline hover:text-[var(--fg-muted)]">cadie.app</a> and any related apps, extensions, or services (collectively, the "Service").
            </p>
            <p className="text-[var(--fg-muted)] mb-8">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">1. Eligibility</h2>
            <p className="text-[var(--fg-muted)] mb-2">
              To use Cadie, you must:
            </p>
            <ul className="list-disc list-inside text-[var(--fg-muted)] mb-4 space-y-1 ml-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">2. Your Account</h2>
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">3. Using Cadie</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">4. Your Content</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">5. Data, Privacy, and Security</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">6. Third-Party Services</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">7. Service Changes and Availability</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">8. Subscription, Payments, and Fees (if applicable)</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">9. Termination</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">10. Disclaimer of Warranties</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">11. Limitation of Liability</h2>
            <p className="text-[var(--fg-muted)] mb-2">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">12. Indemnification</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <ul className="list-disc list-inside text-[var(--fg-muted)] mb-8 space-y-1 ml-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">13. Governing Law</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">14. Changes to These Terms</h2>
            <p className="text-[var(--fg-muted)] mb-4">
            ...
            <h2 className="text-2xl font-semibold text-[var(--fg)] mt-8 mb-4">15. Contact</h2>
            <p className="text-[var(--fg-muted)] mb-4">
              If you have any questions about these Terms or Cadie, you can contact us at:
            </p>
            <p className="text-[var(--fg-muted)] mb-2">
              <strong>Email:</strong> <a href="mailto:mo73426@gmail.com" className="text-[var(--fg)] underline hover:text-[var(--fg-muted)]">mo73426@gmail.com</a>
            </p>
            <p className="text-[var(--fg-muted)] mb-2">
              <strong>Website:</strong> <a href="http://cadie.app" className="text-[var(--fg)] underline hover:text-[var(--fg-muted)]">cadie.app</a>
            </p>
            <p className="text-[var(--fg-muted)] mb-8">

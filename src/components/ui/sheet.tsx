...
const sheetPopupVariants = cva(
  "fixed z-50 flex flex-col gap-4 overflow-y-auto bg-white text-slate-950 shadow-lg transition-[opacity,translate] duration-300 ease-in-out will-change-transform [--sheet-inset:0px] data-ending-style:opacity-0 data-starting-style:opacity-0 dark:bg-slate-950 dark:text-slate-50",
  {
    defaultVariants: {
      inset: false,
      side: "right",

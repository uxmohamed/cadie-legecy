...
export function LogoIcon({ className = "h-8 w-8" }: LogoIconProps) {
  ...
  const bgColor = isDark ? "#343433" : "#F6F4EE";
  const fgColor = isDark ? "#F6F4EE" : "#343433";

      ...
      <main className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pb-24">
          <div className="mx-auto w-full max-w-4xl px-8">
            ...
            <div className="sticky top-0 z-10 flex justify-between items-center py-4 text-xs font-medium text-[var(--text-tertiary)] select-none bg-[var(--bg-l0-solid)] border-b border-[var(--border-tertiary)] -mx-8 px-8">
              <div>Title</div>
              <div>Created at</div>
            </div>
            {fetchingLinks ? (

/**
 * ARCHIVED: Original Dock Component
 * 
 * Archived on: December 7, 2025
 * Reason: Replaced with simplified dock that only contains View Selector.
 *         The Add, Search, and Sort buttons were moved to the header control bar.
 * 
 * This file preserves the full-featured dock with:
 * - Add button with popover
 * - Search button
 * - Sort button with popover
 * - View Selector (All Items / Trash)
 */

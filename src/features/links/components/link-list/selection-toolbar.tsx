...
export function SelectionToolbar({
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 bg-[var(--bg-l2-solid)] border border-[var(--border-primary)] shadow-xl rounded-lg p-1.5 animate-in fade-in slide-in-from-bottom-4 duration-200">
      ...
      <Button
        ...
        className="h-auto gap-1.5 px-3 py-1.5 text-sm font-medium text-[var(--text-secondary)] hover:bg-[var(--bg-field-hover)]"
      >
      ...
      <Button
        ...
        className="h-auto gap-1.5 px-3 py-1.5 text-sm font-medium text-[var(--accent-red-primary)] hover:bg-[var(--accent-red-secondary)]/10 hover:text-[var(--accent-red-primary)]"
      >

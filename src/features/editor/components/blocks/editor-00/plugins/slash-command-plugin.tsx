  ...
  return [
    {
      ...
      onSelect: () =>
        replaceBlockWithNode(editor, () => $createHeadingNode("h1")),
    },
    {
      title: "Heading 2",
      ...
      onSelect: () =>
        replaceBlockWithNode(editor, () => $createHeadingNode("h2")),
    },
    {
      title: "Heading 3",
      ...
      keywords: ["h3", "heading"],
      onSelect: () =>
        replaceBlockWithNode(editor, () => $createHeadingNode("h3")),
    },
    {
      title: "Bulleted List",
    ...
    return editor.registerUpdateListener(({ editorState }) => {
      editorState.read(() => {
        ...
        if (slashIndex >= 0) {
          ...
          const parentNode = $isElementNode(anchorNode)
            ? anchorNode
          ...
          const isValidBlock =
            ...
            ($isParagraphNode(parentNode) ||
              parentNode.getType().startsWith("heading"));

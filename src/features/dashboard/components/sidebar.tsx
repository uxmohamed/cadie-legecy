  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-gray-100 bg-white dark:border-gray-800 dark:bg-[#0d0d0d]">
      ...
      <div className="border-t border-gray-100 p-2 dark:border-gray-800">
        ...
        <button className="mt-1 flex w-full items-center gap-2 rounded px-2 py-1.5 text-left text-sm text-gray-600 transition-colors hover:bg-gray-50 hover:text-gray-900 focus:outline-none focus:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-100 dark:focus:bg-gray-800">
